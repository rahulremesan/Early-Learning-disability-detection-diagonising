...
public class ViewReadSecond extends AppCompatActivity {
    static Hashtable<Integer, String> hashtable= ViewReadFirst.hashtable;
    static Integer QuestionID=ViewReadFirst.QuestionID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_read_second);
        ...
        String url = "http://blackfarm.in/early_diagnosing/View_next_questions.php";

        try {
            List<NameValuePair> list = new ArrayList<>();
            QuestionID++;
            QuestID=Integer.toString(QuestionID);
            list.add(new BasicNameValuePair("question_id", ViewReadSecond.QuestID));
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent l = new Intent(getApplicationContext(),ViewReadSecond.class);//Viewfood
        startActivity(l);
    }
