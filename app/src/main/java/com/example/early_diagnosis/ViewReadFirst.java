...
public class ViewReadFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_read_first);
        ...
        try {
            ...
            list.add(new BasicNameValuePair("question_id", ViewReadFirst.QuestID));
            ...
            if (res.equalsIgnoreCase("1")) {
                ...
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent i = new Intent(getApplicationContext(), com.example.early_diagnosis.ViewReadSecond.class);
                        startActivity(i);
                    }
                });
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent l = new Intent(getApplicationContext(),ViewReadFirst.class);//Viewfood
        startActivity(l);
    }
